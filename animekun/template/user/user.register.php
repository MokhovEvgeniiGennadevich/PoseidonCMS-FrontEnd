...
<?php include('../template/elements/menu.top.php'); ?>
<div class="wrapper">
    ...
    <div class="container">
        ...
        <?php
    $obsurfication = array(
        'user_login'=> random_bytes(7),
        'form_url'  => random_bytes(7),
        'user_name' => random_bytes(7),
        'user_pass' => random_bytes(7),

        'open_iv'   => random_bytes(7),
        'open_key'  => random_bytes(7),
        'open_time' => random_bytes(7),
        'form_url'  => random_bytes(7),
    );
    ...
    <form method="POST" id="user_login">
        ...
        <input type="hidden" name="form_url"  value="<?php echo url_api('users', array('microservice' => 'user', 'module' => 'register')); ?>" />
